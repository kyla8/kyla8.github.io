...
<img width = 600px class="rounded -start pe-4" src="../img/oasdi/oasdi1.png">
...
<img width = 600px class="rounded float-start pe-4" src="../img/oasdi/oasdi2.png">
...
In Figure 2, using historical data of the trust fund balance from 1990 to 2020 from the SSA a trendline was made then extended into the future to predict what the future of the trust fund would look like ("2020 OASDI Trustees Report&rdquo, "Trust Fund Data"). This is also in line with the 2020 Congressional Research Service Report on the SSA’s trust fund, that also predicts that the trust fund will run out of money by 2035 ("Social Security: What would happen if the trust funds ran out?").
...
<img width = 600px class="rounded float-start pe-4" src="../img/oasdi/oasdi3.png">
...
<img width = 600px class="rounded float-start pe-4" src="../img/oasdi/oasdi4.png">
...
<img width = 600px class="rounded float-start pe-4" src="../img/oasdi/oasdi5.png">
...
Franklin, M. B. &ldquo;Impact of raising the Social Security taxable wage base.&rdquo; Investment News, 10 September 2020, www.investmentnews.com/impact-raising-social-security-taxable -wage-base-196953. Accessed 25 March 2021.
